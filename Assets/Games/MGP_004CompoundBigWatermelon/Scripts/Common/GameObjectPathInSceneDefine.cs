...
namespace MGP_004CompoundBigWatermelon
{
	...
	public class GameObjectPathInSceneDefine 
	{
        ...
        //UI_GAME_STOP_IMAGE_PATH
        public const string UI_GAME_STOP_IMAGE_PATH = "Canvas/GameStopImage";
        public const string UI_RESTART_GAME_BUTTON_PATH = "Canvas/GameOverImage/RestartGameButton";
		public const string UI_GAME_OVER_STOP_BUTTON_PATH = "Canvas/GameStopImage/GameButton";
        public const string UI_STOP_BUTTON_PATH = "Canvas/StopButton";
